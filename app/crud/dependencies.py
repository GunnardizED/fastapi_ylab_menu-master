...
async def validate_menu_model(
    ...
    #function is a dependency function that will be used
...
async def validate_submenu_model(
    ...
    #function is a dependency function that will be
    #used by the create_submenu and update_submenu functions. It takes
    #request object, contains the path parameters of the submenu id, and
...
async def get_submenu_id(
    ...
    #function is a dependency function that gets and return
